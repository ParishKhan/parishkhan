    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-emerald-500/30 font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="py-12 md:py-24 space-y-24 md:space-y-32">
          ...
          <HeroSection />
          {/* SKILLS */}
          <section id="skills" className="animate-fade-in scroll-mt-24" style={{ animationDelay: '0.1s' }}>
            <SectionHeading title="skills.json" subtitle="Curated technical toolkit and methodologies." />
            <SkillsCloud />
          </section>
          {/* EXPERIENCE */}
          <section id="experience" className="animate-fade-in scroll-mt-24" style={{ animationDelay: '0.2s' }}>
          ...
          {/* PROJECTS */}
          <section id="projects" className="animate-fade-in scroll-mt-24" style={{ animationDelay: '0.3s' }}>
            <SectionHeading title="active_projects.dir" subtitle="Production platforms and side initiatives." />
            <ProjectGrid />
          </section>
          {/* FOOTER */}
          <footer className="pt-24 pb-24 text-center text-muted-foreground border-t border-muted/30">
